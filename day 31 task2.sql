...
insert into assignments(student_id,student_name,subject_name,assignment_mark)values(101,"nila","Maths",20);
insert into assignments(student_id,student_name,subject_name,assignment_mark)values(102,"karthi","Maths",20);
insert into assignments(student_id,student_name,subject_name,assignment_mark)values(103,"santhosh","Maths",18);
insert into assignments(student_id,student_name,subject_name,assignment_mark)values(104,"minitha","Maths",17);
insert into assignments(student_id,student_name,subject_name,assignment_mark)values(105,"Keerthi","Maths",16);
