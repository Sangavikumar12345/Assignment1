...
student_age int);
select * from user;
insert into user(student_name,student_age) values ("Sangavi",20)
insert into user(student_name,student_age) values ("Dharani",21)
insert into user(student_name,student_age) values ("vijaya",22)
insert into user(student_name,student_age) values ("bharathi",21)
